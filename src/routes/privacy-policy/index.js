  ...
  return (
    <main className='mainContainer'>
      <div className='privacyPolicyContainer'>
        <a className='close pointer closeText' href='/'>
          <svg
        ...
        <h1>Privacy Policy of E-Levy Calculator</h1>
        <p>
          E-Levy Calculator operates the https://www.e-levy-calculator.com/
          website, which provides the SERVICE.
        </p>
        <p>
          This page is used to inform website visitors regarding our policies
          with the collection, use, and disclosure of Personal Information if
          anyone decided to use our Service, the E-Levy Calculator website.
        </p>
        <p>
        ...
        <p>
          ...
          https://www.e-levy-calculator.com/, unless otherwise defined in this
          Privacy Policy.
        </p>
